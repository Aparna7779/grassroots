            ...
            <div class="fixed-sidebar-left">
                <ul class="nav navbar-nav side-nav nicescroll-bar">
                    ...
                    <li>
                        ...
                        <a class="active" href="product-orders.php" ><div class="pull-left"><i class=" fa fa-cart-arrow-down mr-20"></i><span class="right-nav-text">     Orders</span></div><div class="pull-right"></div></i><div class="clearfix"></div></a>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table display responsive product-overview mb-30" id="myTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo "<tr>
                                                        <td class='txt-dark'>$row[0]</td>
                                                        <td class='txt-dark'>$row[1]</td>";
                                                        $pq = "select p_name,unit from product where p_id=$row[2]";
                                                        $qpq = mysqli_query($conn, $pq);
                                                        $prow = mysqli_fetch_assoc($qpq);
                                                        echo "<td>".$prow['p_name']."</td>";
                                                        echo "<td>$row[5]</td>";
                                                        echo "<td>".$prow['unit']."</td>
                                                        <td>$row[3]</td>
                                                        <td>$row[4]</td>
                                                        <td>$row[9]</td>

                                                        <td>
                                                        <span class = 'label label-success font-weight-100'>$row[8]</span>
                                                        </td>";
                                                        echo "<td>$row[6]</td>";
                                                        $pro='PROCESSING';
                                                        $sh='SHIPPED';
                                                        $dl='DELIVERED';
                                                        if($row[6]==='ORDER PLACED')
                                                        {
                                                        echo "<td><a style = 'color:WHITE;' href = 'orderup.php?id=$row[0]&st=$pro'>SET TO PROCESSING </a></td>";
                                                        }
                                                        else if($row[6]==='PROCESSING')
                                                        {
                                                        echo "<td><a style = 'color:BLUE;' href = 'orderup.php?id=$row[0]&st=$sh'>SET TO SHIPPED </a></td>";
                                                        }
                                                        else if($row[6]==='SHIPPED')
                                                        {
                                                        echo "<td><a style = 'color:GREEN;' href = 'orderup.php?id=$row[0]&st=$dl'>SET TO DELIVERED </a></td>";
                                                        }
                                                        else if($row[6]==='CANCELLED')
                                                        {
                                                        echo "<td><a style = 'color:RED;' href = 'orderdel.php?id=$row[0]'>REMOVE</a></td>";
