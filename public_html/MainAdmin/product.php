			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="product.php" ><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="pull-right"></div></i><div class="clearfix"></div></a>
                                        ...
                                        <a class="active" href=product.php" ><div class="pull-left"><i class="  fa fa-cubes mr-20"></i><span class="right-nav-text">      Products</span></div><div class="pull-right"></div></i><div class="clearfix"></div></a>
									...
									<article class='col-item'>
										<div class='photo'>
											<div class='options'>
												...
												<a href='p_del.php?id=$row[0]' class='font-18 txt-grey pull-left sa-warning'><i class='zmdi zmdi-close'></i></a>
											</div>
