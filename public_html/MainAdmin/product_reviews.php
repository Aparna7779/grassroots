			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="products.php" ><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="pull-right"></div></i><div class="clearfix"></div></a>
							...
							<a class="active" href="product_reviews.php" ><div class="pull-left"><i class="fa fa-comments-o mr-20"></i><span class="right-nav-text">     Product reviews</span></div><div class="pull-right"></div></i><div class="clearfix"></div></a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row heading-bg">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h5 class="txt-dark">product reviews</h5>
                        </div>
                        <!-- Breadcrumb -->
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><span>product-reviews</span></li>
                            </ol>
                        </div>
                        <!-- /Breadcrumb -->
                    </div>
...
$q="select p_name from product where p_id=$row[1]";
                                                   $result= mysqli_query($conn, $q);
                                                   $rrow= mysqli_fetch_assoc($result);
                                                   $name=$rrow['p_name'];
                                                        echo "<tr>
                                                        <td class='txt-dark'>$row[1]</td>
                                                        <td class='txt-dark'>$name</td>
                                                        ...
                                                        <td><a href='r_del.php?id=$row[0]' class='text-inverse' title='Delete' data-toggle='tooltip'><i class='zmdi zmdi-delete txt-danger'></i></a></td>
                                                        </tr>";
                                                        }
                                                        }
                                                        ?>
