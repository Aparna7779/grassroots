...
<!-- Top Menu Items -->
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a href="product.php" ><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="pull-right"></div></i><div class="clearfix"></div></a>
					
						
						
                                                    
                                        <a href=product.php" ><div class="pull-left"><i class="  fa fa-cubes mr-20"></i><span class="right-nav-text">      Products</span></div><div class="pull-right"></div></i><div class="clearfix"></div></a>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table display responsive product-overview mb-30" id="myTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        echo "<tr>
                                                        <td class='txt-dark'>$row[1]</td>
                                                        <td class='txt-dark'>$row[2]</td>
                                                        
                                                        <td class='txt-dark'>$row[3]</td>
                                                            <td class='txt-dark'>$row[4]</td>
                                                                <td class='txt-dark'>$row[5]</td>
                                                                    <td class='txt-dark'>$row[6]</td>
                                                                        <td class='txt-dark'>$row[7]</td>
                                                                            <td class='txt-dark'>$row[8]</td>
                                                                                <td class='txt-dark'>$row[9]</td>
                                                       
                                                      
                                                        <td><a href='market_price_edit.php?id=$row[0]' class='text-inverse pr-10' title='Edit' data-toggle='tooltip'><i class='zmdi zmdi-edit txt-warning'></i></a><a href='market_price_delete.php?id=$row[0]' class='text-inverse' title='Delete' data-toggle='tooltip'><i class='zmdi zmdi-delete txt-danger'></i></a></td>
                                                        </tr>";
                                                        }
                                                        }
                                                        ?>
                                                        ...
                                                        <!-- /Row -->
                                                        <a href="market_price_ins.php"><input class="form-control btn btn-primary" type="submit" name="submit" value="Add new data"></a>
                                                        </div>
