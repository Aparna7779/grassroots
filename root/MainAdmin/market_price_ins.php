...
<html lang="en">
                                    ...
                                    <div class="panel-body row">
                                        <div class="table-wrap">
                                            <div class="table-responsive">
                                                <form action="market_price_ins.php" method="POST">
                                                    <table class="table display responsive product-overview mb-30" id="myTable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="date" name="arrd"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" name="minp"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Enter Maximum Price</td>
                                                            <td><input type="text" name="maxp"></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Enter Modal price:</td>
                                                            <td><input type="text" name="mop"></td>
                                                        </tr>
    ...
    $state=$_POST['state'];
     ...
     $maxp=$_POST['maxp'];
     $mop=$_POST['mop'];
    $query = "insert into market_price(`state`, `commodity`, `market`, `arr_date`, `arr`, `variety`, `min_p`, `max_p`, `modal_p`) values('$state','$com','$mar','$arrd','$ar','$v','$minp','$maxp','$mop')";
