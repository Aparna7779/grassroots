				...
				<div class="container-fluid">
					...
					<div class="row heading-bg">
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						  <h5 class="txt-dark">News updates</h5>
						</div>
						<!-- Breadcrumb -->
						<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						  <ol class="breadcrumb">
							<li><a href="product.php">Dashboard</a></li>
							<li><a href="#"><span>News and updates</span></a></li>
							<li class="active"><span>Post new update</span></li>
						  </ol>
						</div>
						<!-- /Breadcrumb -->
					</div>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Post new Update</h6>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="panel-wrapper collapse in">
										...
										<div class="form-wrap">
											<form action="news_add.php" method="post" enctype="multipart/form-data">
												<div class="form-group">
													<label class="control-label mb-10 text-left">Title<span class="help"> </span></label>
												...
												<div><input type="date" name =datepicker></div>
												<div class="form-group mb-0">
													<input type="submit"  name="submit" class="btn btn-success btn-anim" value="submit">
												</div>	
											</form>
										</div>
									</div>
